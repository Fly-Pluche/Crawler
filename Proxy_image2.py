...
if __name__ == '__main__':
    ...
    for n in range(startNum, endNum):
        ...
        log.close()
        req = request.Request(
            url=f'https://wallhaven.cc/search?categories=001&purity=110&topRange=1M&sorting=toplist&order=desc&page={n}',
            headers=headers)
        try:
